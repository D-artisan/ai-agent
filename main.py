...
# Use the real tools from tools.py
...
if __name__ == "__main__":
    ...
    # Simulate tool calling by letting the LLM know about available tools
    ...
    prompt = prompt_template.format(
        query=f"{user_query}\nAvailable tools:\n{tool_descriptions}\nIf you need to use a tool, describe the tool call in your output under 'tools_used'."
    )
    ...
    if not llm_response or not llm_response.strip():
        ...
        try:
            ...
            # Always save the summary to a file using save_text_to_file
            ...
            # Fallback: try to add missing fields and re-parse
            import json
            try:
